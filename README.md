...
当前里程碑是 **投前看简历 · 排查增强**：R1～R7 已可用；听后做复盘暂缓。当前推进 **R8**（`--triage` 与 brief / [#38](https://github.com/IdEvEbI/employ-guard-ai/issues/38)）。顺序见 [开发看板](./docs/03-delivery/001_dev-board_开发看板.md) §5。
