...
当前里程碑是 **投前看简历 · 排查增强**：R1～R12 已可用；听后做复盘暂缓；**R13 本轮跳过**。当前推进 **R3b**（几何规则补强查排版 / [#51](https://github.com/IdEvEbI/employ-guard-ai/issues/51)）。顺序见 [开发看板](./docs/03-delivery/001_dev-board_开发看板.md) §5。
