...
当前里程碑是 **投前看简历 · 排查增强**：R1～R11 已可用；听后做复盘暂缓。当前推进 **R12**（扫描件 OCR / [#49](https://github.com/IdEvEbI/employ-guard-ai/issues/49)）。顺序见 [开发看板](./docs/03-delivery/001_dev-board_开发看板.md) §5。
