...
当前里程碑是 **投前看简历**：书面标准见 [04-standard](./docs/04-standard/README.md)；出图、抽文本与查排版已可用。产品范围以 [产品说明](./docs/01-product/001_prd_就业守护助手产品说明.md) 为准。当前推进 **判能不能投**（[#22](https://github.com/IdEvEbI/employ-guard-ai/issues/22)）。
