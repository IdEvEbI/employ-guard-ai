...
查排版见 [002](./02-architecture/002_check-layout_查排版技术说明.md)；判能不能投见 [003](./02-architecture/003_judge-resume_判能不能投技术说明.md)；查文字表达见 [004](./02-architecture/004_check-writing_查文字表达技术说明.md)；出练习题见 [005](./02-architecture/005_draft-questions_出练习题技术说明.md)。老师命令 `resume` 见 [006](./02-architecture/006_resume_投前看简历技术说明.md)。
